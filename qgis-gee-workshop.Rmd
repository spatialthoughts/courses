...
8. Scroll down in the dialog and delete the defaul help text for both *Filter Image Properties* and *Visualization Parameters (JSON)*. Select `Mosaic` for the *Compositing Method* and click *OK*.
...
21. It is a good practice to save the model along with the QGIS project so it is always available to whoever is using the project file. Click the *ave model in project* button to embed the model in your QGIS project file. 
