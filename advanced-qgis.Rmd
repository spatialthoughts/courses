...
> In our dataset, the are some road geometries that cross district boundaries - causing part of the length being counted as part of another district. You may also use the *Polygons to lines* algorithm on the district layer followed by *Split by Lines* to break the road geometries at district boundaries to get an exact one-to-one match.
