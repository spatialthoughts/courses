...
[![Watch the Video](https://img.youtube.com/vi/vQTknTHLtUQ/mqdefault.jpg)](https://www.youtube.com/watch?v=vQTknTHLtUQ&list=PLppGmFLhQ1HJuIb7qMiKIv11HiEQhy3ha&index=4){target="_blank"}

[Watch the Video &#8599;](https://www.youtube.com/watch?v=vQTknTHLtUQ&list=PLppGmFLhQ1HJuIb7qMiKIv11HiEQhy3ha&index=4){target="_blank"}
...
```{js eval=FALSE, code=readLines('code/end_to_end_gee/03-Supervised-Classification/03b_Feature_Engineering_(complete)')}
```
...
```{js eval=FALSE, code=readLines('code/end_to_end_gee/03-Supervised-Classification/03c_Feature_Engineering_(exercise)')}
```
...
```{js eval=FALSE, code=readLines('code/end_to_end_gee/03-Supervised-Classification/04b_Satellite_Embeddings_(complete)')}
```
...
```{js eval=FALSE, code=readLines('code/end_to_end_gee/03-Supervised-Classification/04c_Satellite_Embeddings_(exercise)')}
```
...
> See more tips and suggestions for scaling your workflows at [Debugging Errors and Scaling Your Analysis
...
[Try in Code Editor &#8599;](https://code.earthengine.google.co.in/?scriptPath=users%2Fujavalgandhi%2FEnd-to-End-GEE%3A03-Supervised-Classification%2F05c_Exporting_Classification_Results_(exercise)){target="_blank"}

```{js eval=FALSE, code=readLines('code/end_to_end_gee/03-Supervised-Classification/05c_Exporting_Classification_Results_(exercise)')}
```


## 06. Visualize Exported Images

[Open in Code Editor &#8599;](https://code.earthengine.google.co.in/?scriptPath=users%2Fujavalgandhi%2FEnd-to-End-GEE%3A03-Supervised-Classification%2F06b_Visualize_Exported_Images_(complete)){target="_blank"}

```{js eval=FALSE, code=readLines('code/end_to_end_gee/03-Supervised-Classification/06b_Visualize_Exported_Images_(complete)')}
```

### Exercise

[Try in Code Editor &#8599;](https://code.earthengine.google.co.in/?scriptPath=users%2Fujavalgandhi%2FEnd-to-End-GEE%3A03-Supervised-Classification%2F06c_Visualize_Exported_Images_(exercise)){target="_blank"}

```{js eval=FALSE, code=readLines('code/end_to_end_gee/03-Supervised-Classification/06c_Visualize_Exported_Images_(exercise)')}
```
