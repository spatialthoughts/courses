...
6. Next *(Windows users)*, search for Anaconda Powershell Prompt and launch it. *(Mac/Linux users)*: Launch a Terminal window. Activate the workshop environment and run the following command to add the QGIS MCP server to Claude Code configuration.
