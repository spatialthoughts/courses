...
4. Click *Paste GitHub URL* and paste the URL to your streamlit `app.py` file. Next, click *Advanced settings...*
...
5. Optionally, you can choose a custom app URL. Once done, click *Deploy!*.

```{r echo=FALSE, fig.align='center', out.width='75%'}
knitr::include_graphics('images/python_dataviz/cloud4.png')
```

6. Your app will now be deployed and will be accessible via the provided URL. You can visit your Dashboard to manage the app once it is deployed.
