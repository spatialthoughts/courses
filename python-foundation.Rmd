...
1. **Graphical User Interface (GUI)**: This method uses the *Anaconda Navigator* program which provides a user-friendly interface to create environment and install packages. This is the preferred way for beginners.
