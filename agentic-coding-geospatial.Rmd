...
# 1. First Steps with Claude Code

## 1.1 Getting Familiar with the Command Prompt

Claude Code's primary interface is the Terminal. We will now cover basic terminal commands that will help you get comfortable with the environment.
