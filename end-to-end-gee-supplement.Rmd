...
[Open in Google Colab &#8599;](https://colab.research.google.com/github/spatialthoughts/courses/blob/master/code/end_to_end_gee/supplement_rf_visualization.ipynb){target="_blank"}
```{r child='end-to-end-gee-output/supplement_rf_visualization.md'}
```
