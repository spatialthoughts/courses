...
```{r echo=FALSE, fig.align='center', out.width='75%', fig.cap='Before applying Mask vs After applying Mask'}
...
```{r echo=FALSE, fig.align='center', out.width='75%', fig.cap='2019 - Monthly rainfall'}
...
```{r echo=FALSE, fig.align='center', out.width='75%', fig.cap='Zonal Statistics'}
