...
```{r echo=FALSE, fig.align='center', out.width='100%', fig.cap='RGB and Thresholded images'}
...
[![View Presentation](images/gee_water_resources_management/gridded_rainfall.png){width="400px"}](https://docs.google.com/presentation/d/1G-v9Nz90DGGQ2OfTPxwD5j-HspPcIYUu9UB-nkNnGn4/edit?usp=sharing){target="_blank"}
...
```{js eval=FALSE, code=readLines('code/gee_water_resources_management/04-Land_Use_Land_Cover_Classification/05b_Exporting_Classification_Results_(complete)')}
```
[Open in Code Editor &#8599;](https://code.earthengine.google.com/?scriptPath=users%2Fujavalgandhi%2FGEE-Water-Resources-Management%3A04-Land_Use_Land_Cover_Classification%2F05b_Exporting_Classification_Results_(complete)){target="_blank"}

```{r echo=FALSE, fig.align='center', out.width='100%', fig.cap='Exported Classification Outputs'}
...
```{js eval=FALSE, code=readLines('code/gee_water_resources_management/04-Land_Use_Land_Cover_Classification/06b_Using_Existing_Landcover_Datasets_(complete)')}
```

[Open in Code Editor &#8599;](https://code.earthengine.google.com/?scriptPath=users%2Fujavalgandhi%2FGEE-Water-Resources-Management%3A04-Land_Use_Land_Cover_Classification%2F06b_Using_Existing_Landcover_Datasets_(complete)){target="_blank"}
...
```{js eval=FALSE, code=readLines('code/gee_water_resources_management/04-Land_Use_Land_Cover_Classification/06c_Using_Existing_Landcover_Datasets_(exercise)')}
```

[Open in Code Editor &#8599;](https://code.earthengine.google.com/?scriptPath=users%2Fujavalgandhi%2FGEE-Water-Resources-Management%3A04-Land_Use_Land_Cover_Classification%2F06c_Using_Existing_Landcover_Datasets_(exercise)){target="_blank"}
...
```{js eval=FALSE, code=readLines('code/gee_water_resources_management/04-Land_Use_Land_Cover_Classification/07b_Calculating_Area_(complete)')}
```

[Open in Code Editor &#8599;](https://code.earthengine.google.com/?scriptPath=users%2Fujavalgandhi%2FGEE-Water-Resources-Management%3A04-Land_Use_Land_Cover_Classification%2F07b_Calculating_Area_(complete)){target="_blank"}
...
```{js eval=FALSE, code=readLines('code/gee_water_resources_management/04-Land_Use_Land_Cover_Classification/07c_Calculating_Area_(exercise)')}

```

[Try in Code Editor &#8599;](https://code.earthengine.google.com/?scriptPath=users%2Fujavalgandhi%2FGEE-Water-Resources-Management%3A04-Land_Use_Land_Cover_Classification%2F07c_Calculating_Area_(exercise)){target="_blank"}
...
```{js eval=FALSE, code=readLines('code/gee_water_resources_management/06-Drought_Monitoring/02c_Apply_Cloud_Mask_(exercise)')}
```
...
```{js eval=FALSE, code=readLines('code/gee_water_resources_management/06-Drought_Monitoring/03c_Extract_and_Scale_NDVI_Band_(exercise)')}
```
...
```{js eval=FALSE, code=readLines('code/gee_water_resources_management/06-Drought_Monitoring/04c_Create_Monthly_Images_(exercise)')}
```
...
```{js eval=FALSE, code=readLines('code/gee_water_resources_management/06-Drought_Monitoring/05c_Calculate_Min_Max_Composites_(exercise)')}
```
...
```{js eval=FALSE, code=readLines('code/gee_water_resources_management/06-Drought_Monitoring/06c_Calculate_VCI_(exercise)')}
```
...
```{js eval=FALSE, code=readLines('code/gee_water_resources_management/07-Earth_Engine_Apps/02c_Building_an_App_with_UI_Widgets_(exercise)')}
```
...
```{js eval=FALSE, code=readLines('code/gee_water_resources_management/07-Earth_Engine_Apps/03c_Performing_Calculations_(exercise)')}
```
...
```{js eval=FALSE, code=readLines('code/gee_water_resources_management/Supplement/Land_Use_Land_Cover_Classification/Calculating_Area_by_Class')}
```

### Hyperparameter Tuning 

```{js eval=FALSE, code=readLines('code/gee_water_resources_management/Supplement/Land_Use_Land_Cover_Classification/Hyperparameter_Tuning')}
```

### Image Normalization and Standardization

```{js eval=FALSE, code=readLines('code/gee_water_resources_management/Supplement/Land_Use_Land_Cover_Classification/Image_Normalization_and_Standardization')}
```

### Post_Processing_Classification_Results

```{js eval=FALSE, code=readLines('code/gee_water_resources_management/Supplement/Land_Use_Land_Cover_Classification/Post_Processing_Classification_Results')}
```

### Principal_Components_Analysis

```{js eval=FALSE, code=readLines('code/gee_water_resources_management/Supplement/Land_Use_Land_Cover_Classification/Principal_Components_Analysis')}
```

### Rainfall_NDVI_Correlation

```{js eval=FALSE, code=readLines('code/gee_water_resources_management/Supplement/Land_Use_Land_Cover_Classification/Rainfall_NDVI_Correlation')}
```

### Seasonal_Composites_for_Crop_Classification

```{js eval=FALSE, code=readLines('code/gee_water_resources_management/Supplement/Land_Use_Land_Cover_Classification/Seasonal_Composites_for_Crop_Classification')}
```

### Spectral_Signatures

```{js eval=FALSE, code=readLines('code/gee_water_resources_management/Supplement/Land_Use_Land_Cover_Classification/Spectral_Signatures')}
```

### Using_SAR_data 

```{js eval=FALSE, code=readLines('code/gee_water_resources_management/Supplement/Land_Use_Land_Cover_Classification/Using_SAR_data')}
```
