...
`load_basemap.py`
```{python eval=FALSE, code=readLines('code/qgis_plugin_workshop/basemap_loader_minimal/load_basemap.py')}
```
...
`load_basemap.py`
```{python eval=FALSE, code=readLines('code/qgis_plugin_workshop/basemap_loader_complete/load_basemap.py')}
```
