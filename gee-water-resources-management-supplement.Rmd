...
[Open in Code Editor &#8599;](https://code.earthengine.google.co.in/?scriptPath=users%2Fujavalgandhi%2FGEE-Water-Resources-Management%3ASupplement%2FHydrology%2FCalculating_SPI){target="_blank"}
```{js eval=FALSE, code=readLines('code/gee_water_resources_management/Supplement/Hydrology/Calculating_SPI')}
```
...
## Dynamic World Water Detection 

```{r echo=FALSE, fig.align='center', out.width='75%', fig.cap='Detecting Surface Water with Dynamic World'}
knitr::include_graphics('images/gee_water_resources_management/dw_water.png')
```

[Open in Code Editor &#8599;](https://code.earthengine.google.co.in/?scriptPath=users%2Fujavalgandhi%2FGEE-Water-Resources-Management%3ASupplement%2FSurface_Water%2FDynamic_World_Water_Detection){target="_blank"}
```{js eval=FALSE, code=readLines('code/gee_water_resources_management/Supplement/Surface_Water/Dynamic_World_Water_Detection')}
```
