---
title: "Mastering GDAL Tools (Free Online Couse)"
...
The code examples in this class use a variety of datasets. All the required datasets are available in the [gdal_tools.zip](http://bit.ly/gdal-tools-data) [~1.3GB]. Download and unzip this file to the `Downloads` directory. All commands below assume the data is available in the ``<home folder>/Downloads/gdal_tools/`` directory.
...
This secsion shows how to take satellite data from Landsat-8 and create various derived products.
