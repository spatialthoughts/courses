...
10.  Search for **Raise expectation** in  *Algorithms* tab and drag to canvas.
...
14  Now close Model Designer and switch back to main QGIS canvas and double click on ```piracy_hexbin``` model in the **Processing toolbox &rarr; Models &rarr; Projects**. In *Base Layer* select **ne_10m_land[EPSG:4326]**, *Grid size* as  **200000**, and *Input points* as **ASAM_events[EPSG:4326]**. Keep *use spatial index* as **unticked** and click Run.
...
16. Now Switch to *Parameters* tab and **tick** *use spatial index*. Click Run
