...
1. Locate the ``sample_gps_track.gpx`` file in the `animating_timeseries/` folder and drag it to the canvas. 
...
24. Once you have the individual frames, you can use a program such as [ezgif.com](https://ezgif.com/) to create an animated GIF from them. The result would look as below. ![[View Animated GIF &#8599;](https://courses.spatialthoughts.com/images/spatial_data_viz/gps17.gif){target="_blank"}]
