...
If you already have a version of QGIS installed in your system un-install that for dependency related errors. To un-install "Settings > Apps > Apps & features > search for QGIS > uninstall". 


1. Visit the [QGIS.org Download](https://qgis.org/en/site/forusers/download.html) page. Click the **OSGeo4W Network Installer** link to download the installer.
...
```
3. In the **OSGeo4W Setup** window, choose **Express Install** and click *Next*. 
...
5. Accept all the terms and conditions and click *Next* to begin your download. 
```{r echo=FALSE, fig.align='center', out.width='75%'}
knitr::include_graphics('images/common/winInstall05.png')
```

> Note since your installing all dependencies with the QGIS-LTR you have to accept few non-open source packages like NetCDF. 

6. Once the download gets completed, search for **QGIS** in the Windows Start Menu and choose the *QGIS Desktop 3.16.8*, click *Open*. 
