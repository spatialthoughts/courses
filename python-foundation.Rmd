...
6. Once the update is done, search for the package ``geopandas``. This is a package that allows you to work with vector geospatial data in Python. Select the first result and click *Apply* to install the package with all its dependencies.
...
9. After the installation completes, click *Launch* button for the *JupyterLab* application. 
