...
**You may also purchase a self-study version of this course with the data package, PDF course material and email support.** [View and purchase on Gumroad](https://gumroad.com/l/rfJDtX).
...
The code examples in this class use a variety of datasets. All the required layers, project files, icons etc. are supplied to you in the ``pyqgis_in_a_day.zip`` with your purchase. Unzip this file to the `Downloads` directory. All scripts assume the data is available in the ``<home folder>/Downloads/pyqgis_in_a_day/`` directory. 
