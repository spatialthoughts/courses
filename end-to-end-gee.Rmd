...
[Explore The App &#8599;](https://santhosh-m.users.earthengine.app/view/night-lights-explorer){target="_blank"}
...
This should be done only once on your machine. If you have already authenticated, processed to next section.
...
After completing the [authentication flow](#configure-authentication), you can run Python scripts using the Earth Engine Python API. Remember that authentication is a one-time process and the token is saved on your machine for future use. 
...
```{r echo=FALSE, fig.align='center', out.width='75%'}
knitr::include_graphics('images/end_to_end_gee/auto_07.png')
```

3. The script will download the data from GEE and save a file to your current directory.

```{r echo=FALSE, fig.align='center', out.width='75%'}
knitr::include_graphics('images/end_to_end_gee/auto_08.png')
```
