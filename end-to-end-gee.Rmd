...
```{js eval=FALSE, code=readLines('code/end_to_end_gee/04-Change-Detection/01b_Spectral_Distance_Change_(complete)')}
```
...
```{js eval=FALSE, code=readLines('code/end_to_end_gee/04-Change-Detection/01c_Spectral_Distance_Change_(exercise)')}
```
...
## 02. Direct Classification of Change
...
```{js eval=FALSE, code=readLines('code/end_to_end_gee/04-Change-Detection/02b_Classifying_Change_(complete)')}
```
[Open in Code Editor &#8599;](https://code.earthengine.google.co.in/?scriptPath=users%2Fujavalgandhi%2FEnd-to-End-GEE%3A04-Change-Detection%2F02b_Classifying_Change_(complete)){target="_blank"}
...
## 03. Post-classification Comparison
...
```{js eval=FALSE, code=readLines('code/end_to_end_gee/04-Change-Detection/03b_Post_Classification_Comparison_(complete)')}
```
[Open in Code Editor &#8599;](https://code.earthengine.google.co.in/?scriptPath=users%2Fujavalgandhi%2FEnd-to-End-GEE%3A04-Change-Detection%2F03b_Post_Classification_Comparison_(complete)){target="_blank"}
...
```
[Try in Code Editor &#8599;](https://code.earthengine.google.co.in/?scriptPath=users%2Fujavalgandhi%2FEnd-to-End-GEE%3A04-Change-Detection%2F03c_Post_Classification_Comparison_(exercise)){target="_blank"}
...
```{js eval=FALSE, code=readLines('code/end_to_end_gee/05-Earth-Engine-Apps/02b_Building_an_App_with_UI_Widgets_(complete)')}
```
...
```
[Try in Code Editor &#8599;](https://code.earthengine.google.co.in/?scriptPath=users%2Fujavalgandhi%2FEnd-to-End-GEE%3A05-Earth-Engine-Apps%2F02c_Building_an_App_with_UI_Widgets_(exercise)){target="_blank"}


# Module 6: Google Earth Engine Python API

## 01. Introduction to the Python API
...
```{r child='end-to-end-gee-output/python_api_syntax.md'}
```
...
## 03. Exporting an ImageCollection 
...
```{r child='end-to-end-gee-output/export_a_collection.md'}
```
...
[View the Notebook &#8599;](https://nbviewer.jupyter.org/github/spatialthoughts/courses/blob/master/code/end_to_end_gee/creating_charts.ipynb)

```{r child='end-to-end-gee-output/creating_charts.md'}
```
...
To enable this script run on your machine or server, you must complete a one-time authentication. This can be done from a terminal using the `earthengine authenticate` command. Once you complete the authentication flow, a token is permanently saved on the machine and will be used by the API automatically.

### Steps for configuration 

1. Activate the ``ee``  environment from Terminal(Mac)/Anaconda Prompt(Windows). If you have not created it, refer to [Installation](https://courses.spatialthoughts.com/end-to-end-gee.html#introduction-to-the-python-api)
...
```{r echo=FALSE, fig.align='center', out.width='75%'}
knitr::include_graphics('images/end_to_end_gee/auto_01.png')
```

2. Once the environment is activated, enter the command to check your installation. To learn more about the command line tool refer to [Earth Engine Guide.](https://developers.google.com/earth-engine/guides/command_line)
...
```{r echo=FALSE, fig.align='center', out.width='75%'}
knitr::include_graphics('images/end_to_end_gee/auto_02.png')
```

3. If the installation is correct, you should get a summary of available commands in the earth engine. If it shows an error, follow the steps in  [Installation](https://courses.spatialthoughts.com/end-to-end-gee.html#introduction-to-the-python-api) to install the library.

```{r echo=FALSE, fig.align='center', out.width='75%'}
knitr::include_graphics('images/end_to_end_gee/auto_03.png')
```

4. Now, let’s authenticate the client library. This command will open the default browser to verify your google earth engine account. Make sure the earth engine account is logged in from that browser.
...
```{r echo=FALSE, fig.align='center', out.width='75%'}
knitr::include_graphics('images/end_to_end_gee/auto_04.png')
```

5. Copy the token and paste it into the terminal/prompt. Click *Enter*. 

```{r echo=FALSE, fig.align='center', out.width='75%'}
knitr::include_graphics('images/end_to_end_gee/auto_05.png')
```

6. You will receive a success message if the authentication is complete. 

```{r echo=FALSE, fig.align='center', out.width='75%'}
knitr::include_graphics('images/end_to_end_gee/auto_06.png')
```
...
```
[Open in Code Editor &#8599;](https://code.earthengine.google.co.in/?scriptPath=users%2Fujavalgandhi%2FEnd-to-End-GEE%3AMiscellaneous%2FCode_Sharing_and_Script_Modules){target="_blank"}
