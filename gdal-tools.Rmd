...
A color relief map is an elevation map where different ranges of elevations are colored differently. The `color-relief` mode can create a color relief map with the colors and elevation ranges supplied in a text file. The format of the text file is `elevation,red,green,blue` values.

Your data package contains a `colormap.txt` file with the following content.
...
```{bash eval=FALSE}
gdalwarp -cutline naip/aoi.shp  -crop_to_cutline naip.vrt aoi.tif ^
...
## Combined Hillsahde and Color-Relief
