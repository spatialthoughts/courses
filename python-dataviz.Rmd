...
```{r child='python-dataviz/01_matplotlib_basics.md'}
```
...
```{r child='python-dataviz/02_creating_charts.md'}
```
...
```{r child='python-dataviz/03_creating_maps.md'}
```
...
```{r child='python-dataviz/04_using_basemaps.md'}
```
...
```{r child='python-dataviz/05_animation_basics.md'}
```
...
```{r child='python-dataviz/06_animating_maps.md'}
```
...
```{r child='python-dataviz/07_visualizing_rasters.md'}
```
...
```{r child='python-dataviz/08_mapping_gridded_datasets.md'}
```
