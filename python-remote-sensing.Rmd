...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/spatialthoughts/courses/blob/master/code/python_remote_sensing/06_calculating_area.ipynb)


```{r child='python-remote-sensing-output/06_calculating_area.md'}
```
