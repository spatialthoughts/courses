...
6. Actions can also be trigged from other interfaces. Let's add this action to the attribute table. Right-click the `parcels` layer and select *Properties*. Switch to the *Actions* tab. At the bottom, check the *Show in Attribute Table* box. Click *OK*.
...
# Replce YOUR_ACCESS_TOKEN with your own token below
parameters = {
