...
Your task is to calculate such a score for all the *Apartment Buildings* in your city. Consider the factors that are important to young home buyers. You can design the score using metrics such as:

* Total number of schools within a certain distance
* Total number of parks within a certain distance
* Total number of restaurants within a certain distance
* Distance to nearest metro/rail/bus stop
* ...
...
* Start simply and use a simple buffer. You may add an option to use an *isochrone* instead of simple circular buffer for a more realistic distances.
