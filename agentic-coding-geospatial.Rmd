...
An AI second brain is a persistent digital memory system that stores your notes and ideas. Andrej Karpathy popularized a simple AI-powered system  called [LLM-Wiki](https://gist.github.com/karpathy/442a6bf555914893e9891c11519de94f) using the note-taking app Obsidian. In this section, we will learn how to setup a simplified version of this idea to collect and organize an archive of your notes and bookmarks. We will also publish and host them as an auto-updating website on Github Pages so you can always find and recall items from your archive.

[![View Presentation](images/agentic_coding_geospatial/second_brain.png){width="400px"}](https://docs.google.com/presentation/d/1w2N_7FtX4v9nHJoX-se3rLw-KcbfKepEhr9b6Lk7wPI/edit?usp=sharing){target="_blank"}

[Google Slides &#8599;](https://docs.google.com/presentation/d/1w2N_7FtX4v9nHJoX-se3rLw-KcbfKepEhr9b6Lk7wPI/edit?usp=sharing){target="_blank"} [PDF &#8599;](https://github.com/spatialthoughts/courses/releases/download/presentations/Agentic_Coding_for_Geospatial_AI_Second_Brain.pdf)
