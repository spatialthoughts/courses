...
For the most part of the course, we will be using [Google Colab](https://research.google.com/colaboratory/faq.html). This does not require any setup and can be used with a Google account. In Module 5, you will setup a local development environment with conda.
...
- **urban** — All built surfaces - buildings, bridges, roads etc. (Class Value: `0`)
- **bare** — All bare surfaces - exposed soil, sand, rock etc. (Class Value: `1`)
- **water** — All surface water - lake, ponds, rivers, ocean etc. (Class Value: `2`)
- **vegetation** — All types of vegetation - trees, crops, grass etc. (Class Value: `3`)
...
3. This will be the reference image for the sample collection. Next go to **Controld &rarr; Field Collection...*.
