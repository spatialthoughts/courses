...
The code examples in this class use a variety of datasets. All the required layers, project files etc. are supplied to you in the ``advanced_qgis.zip`` file. Unzip this file to the `Downloads` directory.
