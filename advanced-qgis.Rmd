...
*Want to work through the material on your own?* [Purchase the data package](https://gumroad.com/l/oGRub) 
...
The examples in this class use a variety of datasets. All the required layers, project files etc. are supplied to you in the ``advanced_qgis.zip`` file. Unzip this file to the `Downloads` directory.
