...
The code examples in this class use a variety of datasets. All the required datasets and Jupyter notebooksare supplied to you in the ``python_foundation.zip`` file with your purchase. Unzip this file to a directory - preferably to the ``<home folder>/Downloads/python_foundation/`` folder. 
...
Open the notebook named ``04_functions.ipynb``.

----

```{r child='04_functions.md'}
```

\newpage

Open the notebook named ``05_standard_library.ipynb``.

----

```{r child='05_standard_library.md'}
```

\newpage

Open the notebook named ``06_third_party_modules.ipynb``.

----

```{r child='06_third_party_modules.md'}
```

\newpage

Open the notebook named ``07_loops_and_conditionals.ipynb``.

----

```{r child='07_loops_and_conditionals.md'}
```

\newpage

Open the notebook named ``08_reading_files.ipynb``.

----

```{r child='08_reading_files.md'}
```

\newpage

Open the notebook named ``09_reading_csv_file.ipynb``.

----

```{r child='09_reading_csv_files.md'}
```
...
Open the notebook named ``16_raster_computation.ipynb``.

----

```{r child='16_raster_computation.md'}
```
...
You achieve mastery in programming by practice and solving as many diverse problems as you can. So I strongly recommend picking up a project and implementing it in Python to improve your skills. You can also take other courses to learn aspects of Python and spatial data processing.
...
If you took this class online or purchased a self-study package, it includes email support to help you when you get stuck in implementation.
