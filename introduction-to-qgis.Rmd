...
The code examples in this class use a variety of datasets. All the required datasets are supplied in the ``introduction_to_qgis.zip`` file. Unzip this file to a directory - preferably to the ``<home folder>/Downloads/introduction_to_qgis/`` folder. 
...
> Note: [Windows Users] in *Choose a Delimited Text File to Open* dialog, choose the *File Type* as **All**. TSV files will not be showen in Text file format. 
