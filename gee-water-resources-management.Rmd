...
> See our new course [Cloud Native Remote Sensing with Python](https://courses.spatialthoughts.com/python-remote-sensing.html) for doing remote sensing using a fully open-source and platform independent approach.
...
[Open in Code Editor &#8599;](https://code.earthengine.google.co.in/?scriptPath=users%2Fujavalgandhi%2FEnd-to-End-GEE%3A03-Supervised-Classification%2F03b_Feature_Engineering_(complete)){target="_blank"}

```{js eval=FALSE, code=readLines('code/gee_water_resources_management/04-Land_Use_Land_Cover_Classification/03b_Feature_Engineering_(complete)')}
```

### Exercise

[Try in Code Editor &#8599;](https://code.earthengine.google.co.in/?scriptPath=users%2Fujavalgandhi%2FEnd-to-End-GEE%3A03-Supervised-Classification%2F03c_Feature_Engineering_(exercise)){target="_blank"}

```{js eval=FALSE, code=readLines('code/gee_water_resources_management/04-Land_Use_Land_Cover_Classification/03c_Feature_Engineering_(exercise)')}
```


## 04. Using Satellite Embeddings

[Satellite Embedding](https://developers.google.com/earth-engine/datasets/catalog/GOOGLE_SATELLITE_EMBEDDING_V1_ANNUAL) is a wew global dataset produced by Google DeepMind’s AlphaEarth Foundations model. The model ingests time-series of many different earth observation datasets to produce a unified digital representation of each pixel - called **embeddings**. The embeddings are provided as an analysis-ready dataset in Earth Engine with yearly images from 2017-current. Embeddings can be used as input features to the classification model and results in higher accuracy outputs.

[Open in Code Editor &#8599;](https://code.earthengine.google.co.in/?scriptPath=users%2Fujavalgandhi%2FEnd-to-End-GEE%3A03-Supervised-Classification%2F04b_Satellite_Embeddings_(complete)){target="_blank"}

```{js eval=FALSE, code=readLines('code/gee_water_resources_management/04-Land_Use_Land_Cover_Classification/04b_Satellite_Embeddings_(complete)')}
```

### Exercise

[Try in Code Editor &#8599;](https://code.earthengine.google.co.in/?scriptPath=users%2Fujavalgandhi%2FEnd-to-End-GEE%3A03-Supervised-Classification%2F04c_Satellite_Embeddings_(exercise)){target="_blank"}

```{js eval=FALSE, code=readLines('code/gee_water_resources_management/04-Land_Use_Land_Cover_Classification/04c_Satellite_Embeddings_(exercise)')}
```
...
[![Start Module 6 Videos](https://img.youtube.com/vi/Kx39XL7BfOA/mqdefault.jpg)](https://www.youtube.com/watch?v=Kx39XL7BfOA&list=PLppGmFLhQ1HI0YeA5zQHxdNlmxihvBawF&index=82){target="_blank"}

[Start Module 6 Videos &#8599;](https://www.youtube.com/watch?v=Kx39XL7BfOA&list=PLppGmFLhQ1HI0YeA5zQHxdNlmxihvBawF&index=82){target="_blank"}
...
The Earth Engine Javascript API includes a `ui` module that allows you to build interactive web-mapping apps easily. Earth Engine also provides free cloud-hosting to host the app that can be shared with stakeholders. This module will introduce you to GEE Apps by creating a simple [Surface Water Explorer App](https://ujavalgandhi.users.earthengine.app/view/surface-water-explorer).

[![Start Module 7 Videos](https://img.youtube.com/vi/gQKSoPpXf4k/mqdefault.jpg)](https://www.youtube.com/watch?v=gQKSoPpXf4k&list=PLppGmFLhQ1HI0YeA5zQHxdNlmxihvBawF&index=97){target="_blank"}

[Start Module 7 Videos &#8599;](https://www.youtube.com/watch?v=gQKSoPpXf4k&list=PLppGmFLhQ1HI0YeA5zQHxdNlmxihvBawF&index=97){target="_blank"}
...
This section has been moved to the Supplement at [Pie Chart Group Statistics](https://courses.spatialthoughts.com/gee-water-resources-management-supplement#pie-chart-group-statistics).
...
This section has been moved to the Supplement at [Chart Cumulative Rainfall](https://courses.spatialthoughts.com/gee-water-resources-management-supplement#chart-cumulative-rainfall).

### Exporting Precipitation Data

This section has been moved to the Supplement at [Exporting Precipitation Data](https://courses.spatialthoughts.com/gee-water-resources-management-supplement#exporting-precipitation-data).

### GPM Precipitation Time Series

This section has been moved to the Supplement at [GPM Precipitation Time Series](https://courses.spatialthoughts.com/gee-water-resources-management-supplement#gpm-precipitation-time-series).

### IMD Number of Rainy Days 

This section has been moved to the Supplement at [IMD Number of Rainy Days](https://courses.spatialthoughts.com/gee-water-resources-management-supplement#imd-number-of-rainy-days).
...
This section has been moved to the Supplement at [Detect First Year of Water](https://courses.spatialthoughts.com/gee-water-resources-management-supplement#detect-first-year-of-water).


### Otsu Dynamic Thresholding

This section has been moved to the Supplement at [Otsu Dynamic Thresholding](https://courses.spatialthoughts.com/gee-water-resources-management-supplement#otsu-dynamic-thresholding).


### Smoothing Vectors 

This section has been moved to the Supplement at [Smoothing Vectors](https://courses.spatialthoughts.com/gee-water-resources-management-supplement#smoothing-vectors).


### Surface Water Explorer Split Panel App

This section has been moved to the Supplement at [Surface Water Explorer Split Panel App](https://courses.spatialthoughts.com/gee-water-resources-management-supplement#surface-water-explorer-split-panel-app).


### Unsupervised Clustering Advanced

This section has been moved to the Supplement at [Unsupervised Clustering Advanced](https://courses.spatialthoughts.com/gee-water-resources-management-supplement#unsupervised-clustering-advanced).

## SAR

### Sentinel-1 ARD Pre-Processing

This section has been moved to the Supplement at [Sentinel-1 ARD Pre-Processing](https://courses.spatialthoughts.com/gee-water-resources-management-supplement#sentinel-1-ard-pre-processing).
...
This section has been moved to the Supplement at [Mann Kendall Test](https://courses.spatialthoughts.com/gee-water-resources-management-supplement#mann-kendall-test).
