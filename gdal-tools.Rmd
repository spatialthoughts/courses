...
```
gdal_translate -of GTiff merged.vrt merged.tif -co COMPRESS=DEFLATE -co TILED=YES
```

### Setting NoData Values

```
gdal_translate -of GTiff merged.vrt merged.tif -co COMPRESS=DEFLATE -co TILED=YES -a_nodata -9999
```
...
# Resources
* [GDAL Tips @gdaltips](https://twitter.com/gdaltips) on Twitter
