...
1. [Download the Anaconda Installer](https://www.anaconda.com/products/individual#Downloads) for Python 3.12 (or a higher version) for your operating system. Once downloaded, double click the installer and install it into the default suggested directory. Select an install for *Just Me* and **use default settings**. 
