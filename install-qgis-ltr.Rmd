...
7. Once the download gets completed, search for **QGIS** in the Windows Start Menu and choose the *QGIS Desktop 3.34*, click *Open*. 
...
1. Visit the [QGIS.org Download](https://qgis.org/en/site/forusers/download.html) page. Go to **Download for macOS** under *Installation Downloads*. Click on the link with the text *Looking for the most stable version? Get QGIS 3.34 LTR* to start the download.
...
8. You now have QGIS-LTR version 3.34 running on your Ubuntu system.
