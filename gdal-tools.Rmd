...
Rasterio provides a command-line utility called [`rio`](https://rasterio.readthedocs.io/en/stable/cli.html) to performa various raster operations on the command-line. The [`rio-cogeo`](https://cogeotiff.github.io/rio-cogeo/) plugin to Rasterio adds support for creation and validation of COGs.
