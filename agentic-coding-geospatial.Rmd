...
We will configure and use the QGIS MCP server to allow Claude Code to use QGIS directly. Please follow our [QGIS-LTR Installation Guide](install-qgis-ltr.html) to install QGIS. Any recent QGIS version is fine for this class.
