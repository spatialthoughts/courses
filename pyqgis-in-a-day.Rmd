---
title: "Customizing QGIS with Python (Free Online Course)"
...
Actions provide an easy way to add custom behavior to QGIS without having to write plugins. Actions are integrated into the QGIS GUI and allow you to execute PyQGIS code on a vector layer.
