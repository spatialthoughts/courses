...
4. Paste the following content in the editor. Remember to change `jammy` with the name of your ubuntu version. After that press `Ctrl+O` (Save), now you will be prompted to give a file name. Leave it to default and press `Enter`, then press by `Ctrl+X` (Exit).
