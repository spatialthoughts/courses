...
Once you run this script, the *Tasks* tab will be highlighted. Click on it you will see the images to be exported will be ready. Click *Run* to start the process.  

```{r echo=FALSE, fig.align='center', out.width='75%'}
knitr::include_graphics('images/end_to_end_gee/export_task01.png')
```

Then a dialog box will be prompted to confirm the export details, after verifying click *Run* to export

```{r echo=FALSE, fig.align='center', out.width='75%'}
knitr::include_graphics('images/end_to_end_gee/export_task02.png')
```

Once the Export finishes, a GeoTiff file will be added to your Google Drive in the specified folder. You can download it and use it in any GIS software.
