...
The exercises in this class use a variety of datasets. All the required layers, project files etc. are supplied to you in the file ``spatial_data_viz.zip`` with the class materials. Unzip this file to the `Downloads` directory.
