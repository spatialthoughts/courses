...
7. Once the download gets completed, search for **QGIS** in the Windows Start Menu and choose the *QGIS Desktop 3.28*, click *Open*. 

> You may have a slightly different minor version than shown here. As long as the version number starts with 3.28, it should be fine.
...
1. Visit the [QGIS.org Download](https://qgis.org/en/site/forusers/download.html) page. Go to **Download for macOS** under *Installation Downloads*. Click on the link with the text *Looking for the most stable version? Get QGIS 3.28 LTR* to start the download.
...
8. You now have QGIS-LTR version 3.28 running on your Ubuntu system.
...
```
conda install qgis=3.28.9 --c conda-forge 
```
