...
19. Zoom to another waterbody and digitize with the same process. If the waterbody name is unavailable in both basemap and scanned map, leave the *name* field empty and select the *status* of the waterbody. Click *OK*. 
...
8. We have now a layer representing the area within 1 km of a metro station within the city of Bengaluru.
...
1. Click on the Open Data Source Manager button. Select the *Raster* tab. Click the *...* button next to *Raster Dataset(s)* and browse to the data directory. Locate the ``bangalore_ppp_2020_constrained.tif`` in the data package. Click *Add*.
