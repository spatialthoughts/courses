...
9. Once the download gets completed, search for **QGIS** in the Windows Start Menu and choose the *QGIS Desktop 3.34*, click *Open*. 
...
### Install QGIS from Official Installer
...
2. Go to **Download for macOS** under *Installation Downloads*. Click on the **Long Term Version for Mac OS (3.34 LTR)** to start the download.
...
### Install QGIS from Third-party Installers
