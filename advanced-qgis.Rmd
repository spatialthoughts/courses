...
```{r echo=FALSE, fig.align='center'}
knitr::include_graphics('images/advanced_qgis/locator.png')
```
[View Animated GIF](images/advanced_qgis/locator.gif){target="_blank"}
...
```{r echo=FALSE, fig.align='center'}
knitr::include_graphics('images/advanced_qgis/inplace2.png')
```
[View Animated GIF](images/advanced_qgis/inplace2.gif){target="_blank"}
...
```
[View Animated GIF](images/advanced_qgis/timeseries6.gif){target="_blank"}
...
```{r echo=FALSE, fig.align='center'}
knitr::include_graphics('images/advanced_qgis/timeseries10.png')
```
[View Animated GIF](images/advanced_qgis/timeseries10.gif){target="_blank"}
...
```{r echo=FALSE, fig.align='center'}
knitr::include_graphics('images/advanced_qgis/3d.png')
```
[View Animated GIF](images/advanced_qgis/3d.gif){target="_blank"}
...
```
[View Animated GIF](images/advanced_qgis/aggregate5.gif){target="_blank"}
...
```
[View Animated GIF](images/advanced_qgis/aggregate7.gif){target="_blank"}
