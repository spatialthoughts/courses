...
Open the QGIS Python Console from **Plugins $rarr; Python Console** and click the **Show Editor** button. Paste the following code and click the **Run** button.

```{py eval=FALSE, code=readLines('code/end_to_end_gee/ee_qgis.py')}
```

Once the code runs, the resulting image computed by Earth Engine and will be streamed to QGIS as a new layer.
