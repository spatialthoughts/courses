...
To run Python scripts using the `ee` module, you must complete a one-time authentication. Follow the steps below to complete the authentication. Once you complete the authentication flow, a token is permanently saved on the machine and will be used by the API automatically. This should be done only once on your machine. Y
...
> Make sure you have completed the [one-time authentication flow](#configure-authentication) before running the script.
