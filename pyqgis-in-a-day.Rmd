...
3. `layer.deleteAttribute(1)`: The `deleteAttribute()` is a method from `QgsVectorLayer` class. It takes the index of the attribute to be deleted. Here we pass on index `1` for the 2nd attribute. (index 0 is the first attribute)
...
filename = 'srtm.tif'
uri = os.path.join(data_dir, filename)
iface.addRasterLayer(uri, 'srtm', 'gdal')
...
results = processing.run("qgis:hillshade", 
    {'INPUT': srtm, 
    'Z_FACTOR':2,
    'AZIMUTH':300,
    'V_ANGLE':40,
