...
**This course is also offered as an in-person class. To attend one of my workshops, visit the [Upcoming Classes](https://spatialthoughts.com/events/) page. You may also sign up for [my mailing list](https://mailchi.mp/1d44f6c0c955/spatialthoughts) to know when new sessions are scheduled.**
...
The code examples in this class use a variety of datasets. All the required layers, project files, icons etc. are available in the [pyqgis_in_a_day.zip](https://drive.google.com/uc?export=download&id=1VvQwNZK6yc3Bnw0GWc6gftIHmNyNPoDK) [~70MB]. Download and unzip this file to the `Downloads` directory. All scripts assume the data is available in the ``<home folder>/Downloads/pyqgis_in_a_day/`` directory. 
...
We can compelte the function using the code we used previously
...
> Note: the ``@alg`` decorator is available only from QGIS 3.6 onwards.
...
&copy; 2019 Ujaval Gandhi [www.spatialthoughts.com](https://spatialthoughts.com)