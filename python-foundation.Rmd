...
**You may also purchase a self-study version of this course with the data package, Jupyter notebooks, exercise solutions, PDF course material and email support.** [View and purchase on Gumroad](https://gumroad.com/l/RTkk).
...
The code examples in this class use a variety of datasets. All the required datasets and Jupyter notebooks are supplied to you in the ``python_foundation.zip`` file with your purchase. Unzip this file to a directory - preferably to the ``<home folder>/Downloads/python_foundation/`` folder. 
...
If you took this class online or purchased a self-study package, you can email me for support and help as you work through your chosen project.
...
If you would like to use this material for commercial use or for teaching a course, you can purchase a license. [Click to view and purchase on Gumroad](https://gum.co/mWcYL).
