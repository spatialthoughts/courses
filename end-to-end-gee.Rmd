...
Once you run this program, the *Tasks* tab will be highlighted. Click on it you will see the Exports will be read you be downloaded. Click *Run*. 

```{r echo=FALSE, fig.align='center', out.width='75%'}
knitr::include_graphics('images/end_to_end_gee/export_task01.png')
```

A dialog box will be prompted to confirm the download details, after verifying click *Run* to download.

```{r echo=FALSE, fig.align='center', out.width='75%'}
knitr::include_graphics('images/end_to_end_gee/export_task02.png')
```

The downloaded *.tif* image can be viewed in desired solftware. 
