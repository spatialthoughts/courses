 ...
 *(Windows users)*, search for Anaconda Powershell Prompt and launch it. *(Mac/Linux users)*: Launch a Terminal window. Create a new environment and install the `uv` package manager which is required by the QGIS MCP server.
...
5. Next *(Windows users)*, search for Anaconda Powershell Prompt and launch it. *(Mac/Linux users)*: Launch a Terminal window. Activate the workshop environment.
