...
- \fancyfoot[CE,CO]{{\includegraphics[width=0.4cm]{images/cc.png}} {\includegraphics[width=0.4cm]{images/by.png}} Ujaval Gandhi http://www.spatialthoughts.com}
classoption: a4paper
---
...
```{python eval=FALSE, code=readLines('code/startup.py')}
```
...
```{python eval=FALSE, code=readLines('code/save_attributes_console.py')}
```
...
```{python eval=FALSE, code=readLines('code/save_attributes_standalone.py')}
```
...
```{python eval=FALSE, code=readLines('code/run_script.bat')}
```
...
```{python eval=FALSE, code=readLines('code/save_attributes_processing.py')}
```
...
`metadata.txt`
```{python eval=FALSE, code=readLines('code/minimal/metadata.txt')}
```
...
`__init__.py`
```{python eval=FALSE, code=readLines('code/minimal/__init__.py')}
```
...
`save_attributes.py`
```{python eval=FALSE, code=readLines('code/minimal/save_attributes.py')}
```
...
```{r echo=FALSE, fig.align='center'}
knitr::include_graphics('images/pluginminimalshow.png')
```
...
```{python eval=FALSE, code=readLines('code/processing/save_attributes_provider.py')}
```
...
`save_attributes.py`
```{python eval=FALSE, code=readLines('code/processing/save_attributes.py')}
```
...
```{python eval=FALSE, code=readLines('code/gui/save_attributes_dialog.py')}
```
...
`save_attributes.py`
```{python eval=FALSE, code=readLines('code/gui/save_attributes.py')}
```
...
`utm_zone.py`
```{python eval=FALSE, code=readLines('code/utm_zone.py')}
```
