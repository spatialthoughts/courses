...
knitr::include_graphics('images/spatial_data_viz/winInstall1.png')
```
...
```{r echo=FALSE, fig.align='center', out.width='75%'}
knitr::include_graphics('images/spatial_data_viz/winInstall2.png')
```
...
```{r echo=FALSE, fig.align='center', out.width='75%'}
knitr::include_graphics('images/spatial_data_viz/winInstall3.png')
```
...
```{r echo=FALSE, fig.align='center', out.width='75%'}
knitr::include_graphics('images/spatial_data_viz/winInstall4.png')
```

5. Once the download gets completed, search for **QGIS** in the Windows Start Menu and choose the *QGIS Desktop 3.16*, click *Open*. 

```{r echo=FALSE, fig.align='center', out.width='75%'}
knitr::include_graphics('images/spatial_data_viz/winInstall5.png')
```
...
```{r echo=FALSE, fig.align='center', out.width='75%'}
knitr::include_graphics('images/spatial_data_viz/mac1.png')
```
...
```{r echo=FALSE, fig.align='center', out.width='75%'}
knitr::include_graphics('images/spatial_data_viz/mac2.png')
```

3. It will copy the appication to the *Application* folder. This process can take upto 15 minutes.

```{r echo=FALSE, fig.align='center', out.width='60%'}
knitr::include_graphics('images/spatial_data_viz/mac3.png')
```

4. Once finished, Go to the *Applications* folder. Find the **QGIS-LTR** application and double-click to launch it.

```{r echo=FALSE, fig.align='center', out.width='75%'}
knitr::include_graphics('images/spatial_data_viz/mac4.png')
```
...
knitr::include_graphics('images/spatial_data_viz/mac5.png')
```
...
```{r echo=FALSE, fig.align='center', out.width='75%'}
knitr::include_graphics('images/spatial_data_viz/mac6.png')
```
