...
Earth Engine makes it very easy to plot variables over time and compare trends of different regions. Here we taked the LandScan population dataset and compare the population of two countries over time.
