...
This course uses Google Colab for all exercises. You do not need to install any packages or download any datasets. The notebooks can be accessed by clicking on the ![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg) buttons at the beginning of each section. You may also access them directly from the [GitHub repository](https://github.com/spatialthoughts/python-dataviz-web).
...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/spatialthoughts/python-dataviz-web/blob/main/08_interactive_maps_folium.md.ipynb)
...
We will be using Anaconda to insteall ``streamlit`` and related packages on your machine. Please review the [Anaconda Installation Guide](https://courses.spatialthoughts.com/python-foundation.html#installation-and-setting-up-the-environment) for step-by-step instructions.
...
```{r child='python-dataviz-output/supplement_animation_basics.md'}
```
