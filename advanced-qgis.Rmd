...
8. Now, right-click the ```piracy_hexbin``` model and select *Edit Model…*. Search **Create spatial index** in *Algorithms* tab and drag it to the model canvas.
...
15. In this instance we got *15.207 s* (The exact time will vary depending on your computer configuration). Also note that it has executed 5 algorithms which is including spatial-index. 
