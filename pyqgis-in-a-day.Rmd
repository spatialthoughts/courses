...
## 10.1 Iterating over Features

In this section, we will learn how to iterate over features of a vector layer, get the value of each attribute and save the results as a CSV file. We will use Pandas library to create a DataFrame and save the results as a CSV file.
...
Hint: See the available methods for the [`QgsVectorLayer`](https://qgis.org/pyqgis/3.28/core/QgsVectorLayer.html) class.

## 10.2 Saving Vector Layers
