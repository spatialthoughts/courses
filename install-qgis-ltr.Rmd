...
> Before you start: If you already have an older version of QGIS installed in your system, you need to un-install it to avoid  dependency related errors. To un-install, go to *Settings &rarr; Apps &rarr; Apps & Features &rarr; search for QGIS &rarr; uninstall*. 
