...
// Change the opacity of the Bars to 80%
// Explore the style role options from https://developers.google.com/chart/interactive/docs/gallery/barchart#bar-styles
```
