...
7. Click on the *Animated Temporal Navigation* (play icon) to get render settings.

```{r echo=FALSE, fig.align='center', out.width='75%'}
knitr::include_graphics('images/advanced_qgis//2d07.png')
```

8. By default,  the date range is today's date. Click *Set to Full Range* (refresh icon) to get the date range of the data.

```{r echo=FALSE, fig.align='center', out.width='75%'}
knitr::include_graphics('images/advanced_qgis//2d08.png')
```

9. Now the data will be set to ``2000-01-02`` to ``2018-01-01``. Since this is yearly data, set the *Step* to **years**. Click *play* button to start rendering.  

```{r echo=FALSE, fig.align='center', out.width='75%'}
knitr::include_graphics('images/advanced_qgis//2d09.png')
```

10. To show the year of display, go to **View &rarr; Decorations &rarr; Title Label Decorations.** Click the checkbox to enable it. 

```{r echo=FALSE, fig.align='center', out.width='75%'}
knitr::include_graphics('images/advanced_qgis//2d10.png')
```

11. Click **Insert an Expression** button and enter the following expression to display the year.
