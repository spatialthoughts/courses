...
The below code example shows how to authenticate a Earth Engine Export job using a service account. The code snippet assumes that the private key file is in the same directory as the scirpt and saved as a file named `.private_key.json`.
...
[Start Guided Project](https://www.youtube.com/playlist?list=PLppGmFLhQ1HJ5VhW6BZfhPX6spUcTY7SR){target="_blank"}
...
[Start Guided Project](https://www.youtube.com/playlist?list=PLppGmFLhQ1HJzzKVS_4v8nBiXLYxAu100){target="_blank"}
...
[Start Guided Project](https://www.youtube.com/playlist?list=PLppGmFLhQ1HJV1CctqanQvXQI1JmqGDDD){target="_blank"}
...
[![Video](images/end_to_end_gee/project_landcover.png){width="400px"}](https://www.youtube.com/playlist?list=PLppGmFLhQ1HLN6ivbJJHLZbEYLdq5zgns){target="_blank"}

[Start Guided Project](https://www.youtube.com/playlist?list=PLppGmFLhQ1HLl0St2wiOPePr58sKu0Vh1){target="_blank"}
...
[![Video](images/end_to_end_gee/project_ntl.png){width="400px"}](https://www.youtube.com/playlist?list=PLppGmFLhQ1HLN6ivbJJHLZbEYLdq5zgns){target="_blank"}

[Start Guided Project](https://www.youtube.com/playlist?list=PLppGmFLhQ1HLN6ivbJJHLZbEYLdq5zgns){target="_blank"}
...
[![Earth Engine Scaling and Debugging](https://img.youtube.com/vi/3AtnpkZTvnk/mqdefault.jpg)](https://www.youtube.com/watch?v=3AtnpkZTvnk){target="_blank"}

[Watch the Video &#8599;](https://www.youtube.com/watch?v=3AtnpkZTvnk){target="_blank"}

[![Using Earth Engine for Very Large Computations](https://img.youtube.com/vi/fsez4HiOc8k/mqdefault.jpg)](https://www.youtube.com/watch?v=fsez4HiOc8k){target="_blank"}

[Watch the Video &#8599;](https://www.youtube.com/watch?v=fsez4HiOc8k){target="_blank"}
