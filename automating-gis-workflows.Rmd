...
> Note: The raods layer has 2 line segments per road, representing the route in both directions.
...
* ``Add autoincremental field``: Simple but very useful algorithm to add a unique integer field. Many databases (even geopackage) requires that each layer has a unique integer field. This algorithm helps creating this field if your source layer is missing it. CAD or CSV layers frequently have this problem,.
...
![](images/automating_gis_workflows/color3.png)
...
![](images/automating_gis_workflows/batch1.png)
...
![](images/automating_gis_workflows/batch6.png)
...
![](images/automating_gis_workflows/batch7.png)

8. Make sure the *Load layers on completion* box is checked and click *Run*.

![](images/automating_gis_workflows/batch8.png)
...
![](images/automating_gis_workflows/batch9.png)

10. Choose all the clipped layers and save the output as ``clipped.gpkg``.

![](images/automating_gis_workflows/batch10.png)
# Packaging Your Work
...
![](images/automating_gis_workflows/package1.png)
...
![](images/automating_gis_workflows/package2.png)
...
![](images/automating_gis_workflows/package3.png)
...
![](images/automating_gis_workflows/package4.png)
...
![](images/automating_gis_workflows/package5.png)
...
![](images/automating_gis_workflows/package6.png)
...
![](images/automating_gis_workflows/package7.png)
...
![](images/automating_gis_workflows/package8.png)
...
![](images/automating_gis_workflows/package9.png)
