...
*Not enrolled in our instrctor-led class but want to work through the material on your own?* [Get free access to the data package](https://docs.google.com/forms/d/e/1FAIpQLSeU4jJDVUFjxPpBoMHjxcy8z6BH6TVhS-jtyYL8TPDvWxn6sw/viewform){target="_blank"}
...
Did you know there are over 1000 tools in the Processing Toolbox that can help you do many different tasks? Click on the image to see my video showing a few of my favorite.
...
There are other advanced functions such as `array_foreach()` and `eval()` that are very powerful. Learn about them in the following video.
...
If you would like to use this material for commercial use or for teaching a course, you can purchase a license. [Click to view  and purchase on Gumroad](https://gumroad.com/l/WRjEX).
