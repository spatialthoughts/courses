...
15. To start digitizing, select the ``banglore_lakes`` layer. Click the *Toggle editing* followed by the *Add Polygon Feature* button. 

```{r echo=FALSE, fig.align='center', out.width='75%'}
knitr::include_graphics('images/introduction_to_qgis/digitizing_15.png')
```

16. Enable snap setting by clicking *Enable Snapping* button. Zoom to any part of the map containing a waterbody. Starting from an edge, keep on adding vertices using left-click. Once the polygon is fully covered, right-click to complete the feature digitization. 
