...
You will notice that the attribute table for the ``rainway_station_bangalore` layer has many columns. Open the attribute table and delete all the columns except the ``osm_id`` column. Hint: Use the *Delete field* tool from the attribute table.
