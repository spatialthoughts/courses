...
1. Open the notebook in Google Colab. Go to **File &rarr; Download &rarr; Download .ipynb** and download the notebook to your computer. Save the file in a folder of your choice. We recommend saving it to `Desktop/`.
...
4. Locate the notebook in Jupyter Lab and click *Run*. It will look for your input data `aoi.geojson` in a subfolder `data/`. If you want to use your own AOI, create this folder and add your file there before executing.
...
1. Create a new file named `batch_processing.py` with the following content. Save the file in a folder of your choice. We recommend saving it to `Desktop/` or another easily accessible location. The key difference in the script compared to the notebook is that we use the Dask Distributed [Progress Bar](https://docs.dask.org/en/stable/diagnostics-distributed.html#progress-bar) to monitor progress. This makes it easy to monitor the progress in the terminal in remote machines. 
