...
[![View Presentation](images/python_foundation/course_overview.png){width="400px"}](https://docs.google.com/presentation/d/125LV0qR47S_OGaZZr5Zv-7lbWfdZ5pNo3iFm6IOX7uI/edit?usp=sharing){target="_blank"}

[View the Presentation &#8599;](https://docs.google.com/presentation/d/125LV0qR47S_OGaZZr5Zv-7lbWfdZ5pNo3iFm6IOX7uI/edit?usp=sharing){target="_blank"}
...
Download [python_foundation.zip](https://drive.google.com/uc?export=download&id=17Zl1PXHjEKpzt_KRqXwpPBXrGB-XntUH).
...
- **Text Processing using LLMs**: Use Large-Language Models to process text and build applications. See [this example](https://nbviewer.org/github/spatialthoughts/projects/blob/master/python/mapping_news_articles_openai.ipynb) of using OpenAI API to extract and map locations from text.
- **Image Segmentation**: [Segment Geospatial](https://samgeo.gishub.org/) is a Python package to extract features from satellite imagery. Use this to extract objects from satellite or drone imagery.
...
* Spatial Thoughts' [Python Tutorials](https://github.com/spatialthoughts/python-tutorials) Videos and Notebooks.
