...
1. Visit the [QGIS.org Download](https://qgis.org/en/site/forusers/download.html) page. Go to 'Download for macOS' under 'Installation Downloads'. Click on the blue link with the text 'Get QGIS 3.28 LTR' to start the download.
...
4. Paste the following content in the editor. Remember to change `jammy` with the name of your ubuntu version. After that press `Ctrl+O` (Save) followed by `Ctrl+X` (Exit).
