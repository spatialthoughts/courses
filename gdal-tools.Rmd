...
GDAL comes with the `gdal_polygonize.py` allowing us to convert rasters to vector. Let's say we want to extract the coordinates of the highest elevation from the merged raster in the [Merging Tiles](#merging-tiles) section. Querying the raster with `gdalinfo -stats` shows us that the highest pixel value is **8748**. 
