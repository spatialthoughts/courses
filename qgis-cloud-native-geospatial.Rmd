...
We have created a data package containing checkpoint projects that will allow you to load the results of each section. You can download the data package from [qgis-cloud-native-geospatial.zip](https://github.com/spatialthoughts/courses/releases/download/data/qgis_cloud_native_geospatial.zip). Once downloaded, unzip the contents to a folder on your computer.
