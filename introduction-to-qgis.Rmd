...
2. The *Plugins* dialog contains all the available plugins in QGIS. Under the *All* tab, search for ``quickmapservices``. This plugin comes pre-installed but needs to be enabled. It has different basemaps that can be used based on the purpose. Check the box next to the *QuickMapServices* label. If you are prompted with *Upgrade Plugin* in the bottom right, click the button to upgrade and then click *Close*.
...
3. Now you will see a new *Web* menu added to the menu-bar. Click on it and expand the *QuickMapServices* menu. Depending upon your QGIS usage, you may or may not have all the basemaps. To enable all the basemap, click on the *Settings*. 
...
4. In the setting's dialog, switch to the *More services* tab. Click on the ``Get contributed pack`` to download and enable all available basemaps. 
...
5. Now under *QuickMapService* menu, you will get the latest available basemaps. The basemaps available here have different terms and conditions to be followed before displaying it in any applications. Hence use it with caution. 
