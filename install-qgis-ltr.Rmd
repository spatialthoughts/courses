...
5. To install the `QGIS-LTR` version from Conda, you must specify the full version name. Search the `conda-forge` repository for available versions. The following command searches for all available packages for the LTR version 3.44 for your operating system.
