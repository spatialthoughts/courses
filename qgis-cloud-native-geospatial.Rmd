...
This workshop requires QGIS LTR version 3.44. Please review [QGIS-LTR Installation Guide](install-qgis-ltr.html) for step-by-step instructions.
...
> Note: The *STAC API Browser* plugin is no longer maintained. QGIS 3.44 includes native support for STAC that is being deveoped actively. [[Learn more](https://www.lutraconsulting.co.uk/blogs/stac-in-qgis)]. This section will be updated to use the native STAC provider once it matures.
