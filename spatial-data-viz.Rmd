...
The exercises in this class use a variety of datasets. All the required layers, project files etc. are supplied to you in the data package which can be downloaded from [spatial_data_viz.zip](https://www.googleapis.com/drive/v3/files/175Fzj9Fjc7f291VXyGuM99tJUwmsjJtf?alt=media&key=AIzaSyAReN2sxd_2utuONnWbeRROLzkkNkDT2sE) (~750MB). . Unzip this file to the `Downloads` directory.
