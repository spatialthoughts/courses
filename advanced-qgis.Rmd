...
27. To save this model in the project, right-click on the layer ```piracy_hexabin``` and choose **Edit**. In the *Model Designer - piracy_hexbin* dialog box, click **Save model in project**. Now the model is saved in ```maritime_piracy``` project.
...
10. Select font size as **25**, set background color as **white.** In placement choose **Bottom Right.** Now click OK.
