...
Agent Skills are a set of instructions that teach an AI agent how to perform specific, multi-step workflows. [Skills in Claude Code]((https://code.claude.com/docs/en/skills)) are defined by a [`SKILL.md`] which serves as the entry point for the skill. You can also publish your skill on GitHub and make it available to others as a plugin.
