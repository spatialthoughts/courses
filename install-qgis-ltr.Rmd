...
7. Once the download gets completed, search for **QGIS** in the Windows Start Menu and choose the *QGIS Desktop 3.16*, click *Open*. 
...
```
conda install qgis=3.22.4 --c conda-forge 
```