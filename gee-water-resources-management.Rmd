...
We have created a YouTube Playlist with separate videos for each script and exercise to enable effective online-learning. [Access the YouTube Playlist &#8599;](https://www.youtube.com/watch?v=TcQ60TIqXf0&list=PLppGmFLhQ1HI0YeA5zQHxdNlmxihvBawF){target="_blank"}

### Vimeo

We are also making combined full-length video for each module available on Vimeo. These videos can be downloaded for offline learning. [Access the Vimeo Playlist &#8599;](https://vimeo.com/user/203041355/folder/19297339){target="_blank"}
