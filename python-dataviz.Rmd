...
Streamlit provides free hosting for your streamlit apps. To run your app on Streamlit Cloud, you need to upload your app to GitHub.
...
2. Click *Paste GitHub URL* and paste the URL to your streamlit `app.py` file. For this example, you may use `https://github.com/spatialthoughts/python-dataviz-web/blob/main/streamlit/route_finder/app.py` for the Route Finder app. Next, click *Advanced settings...*
