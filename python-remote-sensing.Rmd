...
## 4.1 Supervised Classification with Embeddings

[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/spatialthoughts/courses/blob/master/code/python_remote_sensing/module_04/01_supervised_classification.ipynb)


```{r child='python-remote-sensing-output/module_04/01_supervised_classification.md'}
```
