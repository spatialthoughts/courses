...
```
[Try in Code Editor &#8599;](https://code.earthengine.google.co.in/?scriptPath=users%2Fujavalgandhi%2FEnd-to-End-GEE%3A02-Earth-Engine-Intermediate%2F06b_Time_Series_Charts_(complete)){target="_blank"}
...
```
[Open in Code Editor &#8599;](https://code.earthengine.google.co.in/?scriptPath=users%2Fujavalgandhi%2FEnd-to-End-GEE%3A03-Supervised-Classification%2F04b_Hyperparameter_Tuning_(complete)){target="_blank"}
...
```
[Open in Code Editor &#8599;](https://code.earthengine.google.co.in/?scriptPath=users%2Fujavalgandhi%2FEnd-to-End-GEE%3A03-Supervised-Classification%2F05b_Exporting_Classification_Results_(complete)){target="_blank"}
...
```
[Open in Code Editor &#8599;](https://code.earthengine.google.co.in/?scriptPath=users%2Fujavalgandhi%2FEnd-to-End-GEE%3A03-Supervised-Classification%2F06b_Calculating_Area_(complete)){target="_blank"}
...
```
[Try in Code Editor &#8599;](https://code.earthengine.google.co.in/?scriptPath=users%2Fujavalgandhi%2FEnd-to-End-GEE%3A03-Supervised-Classification%2F06c_Calculating_Area_(exercise)){target="_blank"}
...
```
[Open in Code Editor &#8599;](https://code.earthengine.google.co.in/?scriptPath=users%2Fujavalgandhi%2FEnd-to-End-GEE%3A03-Supervised-Classification%2F07b_Classifying_Change_(complete)){target="_blank"}
...
```
[Try in Code Editor &#8599;](https://code.earthengine.google.co.in/?scriptPath=users%2Fujavalgandhi%2FEnd-to-End-GEE%3A03-Supervised-Classification%2F07c_Classifying_Change_(exercise)){target="_blank"}
...
```
[Open in Code Editor &#8599;](https://code.earthengine.google.co.in/?scriptPath=users%2Fujavalgandhi%2FEnd-to-End-GEE%3A03-Supervised-Classification%2F08b_Post_Classification_Comparison_(complete)){target="_blank"}
...
```
[Try in Code Editor &#8599;](https://code.earthengine.google.co.in/?scriptPath=users%2Fujavalgandhi%2FEnd-to-End-GEE%3A03-Supervised-Classification%2F08c_Post_Classification_Comparison_(exercise)){target="_blank"}
...
```
[Open in Code Editor &#8599;](https://code.earthengine.google.co.in/?scriptPath=users%2Fujavalgandhi%2FEnd-to-End-GEE%3A04-Earth-Engine-Advanced%2F01b_Client_vs_Server_(complete)){target="_blank"}
...
```
[Open in Code Editor &#8599;](https://code.earthengine.google.co.in/?scriptPath=users%2Fujavalgandhi%2FEnd-to-End-GEE%3A04-Earth-Engine-Advanced%2F02b_Building_an_App_with_UI_Widgets_(complete)){target="_blank"}
...
```
[Try in Code Editor &#8599;](https://code.earthengine.google.co.in/?scriptPath=users%2Fujavalgandhi%2FEnd-to-End-GEE%3A04-Earth-Engine-Advanced%2F02c_Building_an_App_with_UI_Widgets_(exercise)){target="_blank"}
...
```
[Open in Code Editor &#8599;](https://code.earthengine.google.co.in/?scriptPath=users%2Fujavalgandhi%2FEnd-to-End-GEE%3A04-Earth-Engine-Advanced%2F03b_Code_Sharing_and_Script_Modules_(complete)){target="_blank"}
...
```{r echo=FALSE, fig.align='center', out.width='75%'}
knitr::include_graphics('images/end_to_end_gee/conda1.png')
```

2. (*Windows users*) Once installed, search for *Anaconda Prompt* launch it. (*Mac/Linux users*): Launch a *Terminal* window.

```{r echo=FALSE, fig.align='center', out.width='75%'}
knitr::include_graphics('images/end_to_end_gee/conda2.png')
```
...
```{r echo=FALSE, fig.align='center', out.width='75%'}
knitr::include_graphics('images/end_to_end_gee/conda5.png')
```
...
```{r echo=FALSE, fig.align='center', out.width='75%'}
knitr::include_graphics('images/end_to_end_gee/conda6.png')
```
...
```{r echo=FALSE, fig.align='center', out.width='75%'}
knitr::include_graphics('images/end_to_end_gee/conda7.png')
```
...
```{r echo=FALSE, fig.align='center', out.width='75%'}
knitr::include_graphics('images/end_to_end_gee/conda8.png')
```
...
```{r echo=FALSE, fig.align='center', out.width='75%'}
knitr::include_graphics('images/end_to_end_gee/conda9.png')
```
...
```{r echo=FALSE, fig.align='center', out.width='75%'}
knitr::include_graphics('images/end_to_end_gee/conda10.png')
```
...
```{r echo=FALSE, fig.align='center', out.width='75%'}
knitr::include_graphics('images/end_to_end_gee/conda11.png')
```
...
```{r echo=FALSE, fig.align='center', out.width='75%'}
knitr::include_graphics('images/end_to_end_gee/conda12.png')
```

## 05. Python API Syntax

[View the Notebook &#8599;](https://nbviewer.jupyter.org/github/spatialthoughts/courses/blob/master/code/end_to_end_gee/python_api_syntax.ipynb)
...
[View the Notebook &#8599;](https://nbviewer.jupyter.org/github/spatialthoughts/courses/blob/master/code/end_to_end_gee/export_a_collection.ipynb)
...
```{js eval=FALSE, code=readLines('code/end_to_end_gee/Supplement/Time_Series_Analysis/Moving_Window_Smoothing')}
```

[Open in Code Editor &#8599;](https://code.earthengine.google.co.in/?scriptPath=users%2Fujavalgandhi%2FEnd-to-End-GEE%3ASupplement%2FTime_Series_Analysis%2FMoving_Window_Smoothing){target="_blank"}
...
Many applications require replacing missing pixels in an image with an interpolated value from its temporal neighbors. This gap-filling technique is used in several applications, including:
...
* *Estimating Intermediate Values*: You can use this technique to compute an image for a previously unknown time-step. If you had population rasters at 2010 and 2020 and want to compute a population image for 2019, you can use this technique to compute a linearly interpolated image using the 2010 and 2020 images.

The code for doing this in GEE requires use of a [Save-all Join](https://developers.google.com/earth-engine/guides/joins_save_all). The script here finds before and after images within the specified time-window and computes the interpolated value at all missing pixels.


[Open in Code Editor &#8599;](https://code.earthengine.google.co.in/?scriptPath=users%2Fujavalgandhi%2FEnd-to-End-GEE%3ASupplement%2FTime_Series_Analysis%2FTemporal_Interpolation){target="_blank"}
```{js eval=FALSE, code=readLines('code/end_to_end_gee/Supplement/Time_Series_Analysis/Temporal_Interpolation')}
```

As you can see in this example here, this results in a continuous time-series with cloudy pixels replaced by interpolated values from closest cloud-free pixels. If you are interested in learning how to create such animations, visit the [ImageCollection Visualization](https://developers.google.com/earth-engine/guides/ic_visualization?hl=en) article of the User Guide. 

```{r echo=FALSE, fig.align='center', out.width='100%', fig.cap='Original vs. Interpolated NDVI Time Series'}
knitr::include_graphics('images/end_to_end_gee/temporal_interpolation.gif')
```
...
```{js eval=FALSE, code=readLines('code/end_to_end_gee/Supplement/UI_Widgets_and_Apps/Split_Panel_UI_App')}
```
[Open in Code Editor &#8599;](https://code.earthengine.google.co.in/?scriptPath=users%2Fujavalgandhi%2FEnd-to-End-GEE%3ASupplement%2FUI_Widgets_and_Apps%2FSplit_Panel_UI_App){target="_blank"}
...
1. [Click this link](https://code.earthengine.google.co.in/?accept_repo=users/ujavalgandhi/End-to-End-
