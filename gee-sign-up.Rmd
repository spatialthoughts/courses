...
> In the steps that follow, we have shown the options that you may use to register a noncommercial project for use with our courses. If you are registering a project for a different purpose - you can choose the options that apply to you.
