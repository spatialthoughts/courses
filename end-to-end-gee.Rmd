...
You may want to add a legend for a classified image to your map visualization in your App. Here's a code snippet that shows you may build one using the UI Widgets.
