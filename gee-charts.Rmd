...
## 2.4 Image Class Areas (Pie Chart)
...
[Open in Code Editor &#8599;](https://code.earthengine.google.co.in/?scriptPath=users%2Fujavalgandhi%2FGEE-Charts%3A02-Image_Charts%2F04b_Area_By_Class_Pie_Chart_(complete)){target="_blank"}

```{js eval=FALSE, code=readLines('code/gee_charts/02-Image_Charts/04b_Area_By_Class_Pie_Chart_(complete)')}
```
...
[Open in Code Editor &#8599;](https://code.earthengine.google.co.in/?scriptPath=users%2Fujavalgandhi%2FGEE-Charts%3A02-Image_Charts%2F04c_Area_By_Class_Pie_Chart_(exercise)){target="_blank"}
