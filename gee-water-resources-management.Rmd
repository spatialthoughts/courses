...
```{r echo=FALSE}
embed_url('https://www.youtube.com/watch?v=TcQ60TIqXf0&list=PLppGmFLhQ1HI0YeA5zQHxdNlmxihvBawF&index=1&t=1s&pp=iAQB')
```
...
```{r echo=FALSE}
embed_url('https://www.youtube.com/watch?v=jmCFVpYUcno&list=PLppGmFLhQ1HI0YeA5zQHxdNlmxihvBawF&index=2&t=3s&pp=iAQB')
```
...
```{r echo=FALSE}
embed_url('https://www.youtube.com/watch?v=Gsr5iggYL1g&list=PLppGmFLhQ1HI0YeA5zQHxdNlmxihvBawF&index=3&pp=iAQB')
```
...
```{r echo=FALSE}
embed_url('https://www.youtube.com/watch?v=AMjpXl7ziho&list=PLppGmFLhQ1HI0YeA5zQHxdNlmxihvBawF&index=4&t=94s&pp=iAQB')
```
...
```{r echo=FALSE}
embed_url('https://www.youtube.com/watch?v=xvttGoffReg&list=PLppGmFLhQ1HI0YeA5zQHxdNlmxihvBawF&index=5&pp=iAQB')
```
...
```{r echo=FALSE}
embed_url('https://www.youtube.com/watch?v=-Wnru94TNLs&list=PLppGmFLhQ1HI0YeA5zQHxdNlmxihvBawF&index=6&pp=iAQB')
```
...
```{r echo=FALSE}
embed_url('https://www.youtube.com/watch?v=el1geyPIdbg&list=PLppGmFLhQ1HI0YeA5zQHxdNlmxihvBawF&index=7&pp=iAQB')
```
...
```{r echo=FALSE}
embed_url('https://www.youtube.com/watch?v=npY-vlmTgc8&list=PLppGmFLhQ1HI0YeA5zQHxdNlmxihvBawF&index=8&pp=iAQB')
```
...
```{r echo=FALSE}
embed_url('https://www.youtube.com/watch?v=Rc57XGAE7OA&list=PLppGmFLhQ1HI0YeA5zQHxdNlmxihvBawF&index=9&pp=iAQB')
```
...
```{r echo=FALSE}
embed_url('https://www.youtube.com/watch?v=FSBmaq3nBkI&list=PLppGmFLhQ1HI0YeA5zQHxdNlmxihvBawF&index=10&pp=iAQB')
```
...
```{r echo=FALSE}
embed_url('https://www.youtube.com/watch?v=pFNSAmv4ppE&list=PLppGmFLhQ1HI0YeA5zQHxdNlmxihvBawF&index=11&pp=iAQB')
```
...
```{r echo=FALSE}
embed_url('https://www.youtube.com/watch?v=_Dw1Ct3dq_Q&list=PLppGmFLhQ1HI0YeA5zQHxdNlmxihvBawF&index=12&pp=iAQB')
```
...
```{r echo=FALSE}
embed_url('https://www.youtube.com/watch?v=dDAHUZOqpzA&list=PLppGmFLhQ1HI0YeA5zQHxdNlmxihvBawF&index=13&pp=iAQB')
```
...
```{r echo=FALSE}
embed_url('https://www.youtube.com/watch?v=mkYCSsBJHrE&list=PLppGmFLhQ1HI0YeA5zQHxdNlmxihvBawF&index=14&t=736s&pp=iAQB')
```
...
```{r echo=FALSE}
embed_url('https://www.youtube.com/watch?v=Qhk5OiWcKrA&list=PLppGmFLhQ1HI0YeA5zQHxdNlmxihvBawF&index=15&pp=iAQB')
```
...
```{r echo=FALSE}
embed_url('https://www.youtube.com/watch?v=W0NebGjuWEc&list=PLppGmFLhQ1HI0YeA5zQHxdNlmxihvBawF&index=16&t=530s&pp=iAQB')
```
...
```{r echo=FALSE}
embed_url('https://www.youtube.com/watch?v=AIi0wT_G5cs&list=PLppGmFLhQ1HI0YeA5zQHxdNlmxihvBawF&index=17&pp=iAQB')
```
...
```{r echo=FALSE}
embed_url('https://www.youtube.com/watch?v=OHz98fe3_dk&list=PLppGmFLhQ1HI0YeA5zQHxdNlmxihvBawF&index=18&pp=iAQB')
```
...
```{r echo=FALSE}
embed_url('https://www.youtube.com/watch?v=jjiGBGU1gAc&list=PLppGmFLhQ1HI0YeA5zQHxdNlmxihvBawF&index=19&pp=iAQB')
```
