...
6.  In the *Query Builder*, enter the following expression to select the stations operated by the **BMRCL** - the agency that operates the metro network in the city. Click *OK*.
