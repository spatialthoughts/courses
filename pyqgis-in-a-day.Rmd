<<<<<<< HEAD
---
title: "Customizing QGIS with Python Workshop"
subtitle: "December 14, 2019"
...
[^2]: Code reference https://gis.stackexchange.com/questions/318816/add-help-menu-entry-in-qgis-3-from-startup-py
...
[^3]: Code reference https://github.com/qgis/QGIS/blob/8a3c7b14c367771d096b4a6d006aa3c4b1017dd5/tests/src/python/utilities.py
...
A simple example showing how to create a point layer with 1 feature and 1 attribute. [^5]

[^5]: Code reference https://anitagraser.com/pyqgis-101-introduction-to-qgis-python-programming-for-non-programmers/pyqgis101-creating-editing-a-new-vector-layer/
...
Use the `QgsRasterFileWriter` or `QgsVectorFileWriter` classes for writing layers to disk. [^4]

[^4]: Code reference https://gis.stackexchange.com/questions/285346/add-layers-to-geopackage-using-pyqgis-qgis-3
...
[^7]: Code reference: https://gis.stackexchange.com/a/340615/5160
...
This course is also offered as a in-person class. Please visit [www.spatialthoughts.com](https://spatialthoughts.com) to see the schedule for upcoming sessions.
...
# Get the Data Package
The code examples in this class use a variety of datasets. All the required layers, project files, icons etc. are available in the [pyqgis_in_a_day.zip](http://bit.ly/pyqgis-in-a-day-data) [~70MB]. Download and unzip this file to the `Downloads` directory. All scripts assume the data is available in the ``<home folder>/Downloads/pyqgis_in_a_day/`` directory. 
...
>>>>>>> 2ac595d1ddfbd341812a7b6c6f0bfead2d51dd8a
