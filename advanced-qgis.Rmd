...
4. Save the model as *piracy_hexbin.model3*. Also check the folder in which its being saved. *Processing &arr; models*, from this location QGIS will read the model by default. 
