...
```{r echo=FALSE, fig.align='center', out.width='75%', fig.cap='Spectral Distance'}
knitr::include_graphics('images/end_to_end_gee/spectral_distance.png')
```


```{js eval=FALSE, code=readLines('code/end_to_end_gee/03-Supervised-Classification/06b_Spectral_Distance_Change_(complete)')}
```
[Open in Code Editor &#8599;](https://code.earthengine.google.co.in/?scriptPath=users%2Fujavalgandhi%2FEnd-to-End-GEE%3A03-Supervised-Classification%2F06b_Spectral_Distance_Change_(complete)){target="_blank"}


### Exercise

```{js eval=FALSE, code=readLines('code/end_to_end_gee/03-Supervised-Classification/06c_Spectral_Distance_Change_(exercise)')}
```

[Try in Code Editor &#8599;](https://code.earthengine.google.co.in/?scriptPath=users%2Fujavalgandhi%2FEnd-to-End-GEE%3A03-Supervised-Classification%2F06c_Spectral_Distance_Change_(exercise)){target="_blank"}
...
```{js eval=FALSE, code=readLines('code/end_to_end_gee/04-Earth-Engine-Advanced/01c_Client_vs_Server_(exercise)')}
```
[Try in Code Editor &#8599;](https://code.earthengine.google.co.in/?scriptPath=users%2Fujavalgandhi%2FEnd-to-End-GEE%3A04-Earth-Engine-Advanced%2F01c_Client_vs_Server_(exercise)){target="_blank"}
...
This script below provides a complete example of automating a download using Google Earth Engine API.
It uses the Google Earth Engine API to compute the average soil moisture for the past 1-week over all districts in a state. The result is then downloaded as a JSON file and saved locally.
