...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/spatialthoughts/python-dataviz-web/blob/main/supplement_barchart_with_labels.ipynb)

```{r child='python-dataviz-output/supplement_barchart_with_labels.md'}
```
