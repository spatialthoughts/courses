...
Download [gdal-tools.zip](https://drive.google.com/uc?export=download&id=1JzRmxStcCiyxlLRNZCC5nkVH12Hmr1ZE).
...
* Has internal tiling (i.e. TILED=YES)
* LZW Compressed (i.e. COMPRESS=LZW by default)
* Automatic Selection of Predictor (i.e. PREDICTOR=YES chooses appropriate predictor for data type)
...
python %CONDA_PREFIX%\Scripts\ogr_layer_algebra.py Clip \
  ...
  -output_ds spatial_query.gpkg -output_lyr selected -nlt POINT
```
