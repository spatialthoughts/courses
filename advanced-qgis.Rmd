...
3. To create spatial index  right-click the **Aggregate** layer and select *Properties*. 
...
6. Select **Aggregate** layer as the *Input layer* and click *Run*. 

```{r echo=FALSE, fig.align='center', out.width='75%'}
knitr::include_graphics('images/advanced_qgis/Index06.png')
```

7. Creating a spatial index is usually a fast operation. Once the algorithm finishes, right-click on the **Aggregate** layer and select *Properties*. Switch to the *Source* tab and you will see that the button has now changed to *Spatial Index Exists* - indicating that the layer now has a spatial index.
